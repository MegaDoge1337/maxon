...
var UserWhere = struct {
	...
	Created:  whereHelpernull_Time{field: "\"users\".\"created\""},
}
...
func (o *User) GetRoles() RoleSlice {
	if o == nil {
		return nil
	}
...
var (
	userAllColumns            = []string{"id", "username", "email", "password", "created"}
...
func (userL) LoadRoles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser any, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`roles`),
		qm.WhereIn(`roles.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
