...
var RoleWhere = struct {
	...
	UserID: whereHelperint{field: "\"roles\".\"user_id\""},
...
var (
	roleAllColumns            = []string{"id", "user_id", "name"}
	roleColumnsWithoutDefault = []string{"user_id", "name"}
...
func (roleL) LoadUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRole any, mods queries.Applicator) error {
	var slice []*Role
	var object *Role
